...
const WatchlistList: FC<WatchlistListProps> = ({
	...
	return (
		<div className="fixed left-0 top-16 h-full w-1/6 bg-white dark:bg-gray-900 transition-all duration-100 shadow-lg border-r-2 border-gray-200 dark:border-gray-700 py-2">
			<div className="my-6">
